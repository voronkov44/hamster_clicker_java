...
<main>
  ...
  <img id="clickableImage" src="<%= request.getContextPath() %>/photo/hamster_Clown.png" alt="Хомяк" />
  <div id="counter">Счет: 0</div>
  <audio id="audio" src="<%= request.getContextPath() %>/audio/clown.mp3" preload="auto"></audio>
</main>
